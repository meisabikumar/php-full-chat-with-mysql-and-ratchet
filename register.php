...
if (isset($_POST["register"])) {
    ...
    if (is_array($user_data) && count($user_data) > 0) {
        ...
        if ($user_object->save_data()) {
            ...
            // $mail->Username   = '3f22132cce46a8';                     // SMTP username
            // $mail->Password   = '20ac459a4c6b29';
            ...
            //     <p><a href="http://localhost/php-full-chat/verify.php?code='.$user_object->getUserVerificationCode().'">Click to Verify</a></p>
            //     <p>Thank you...</p>
            // ';
                        ...
                        <form method="post" id="register_form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="user_name" id="user_name" class="form-control"
                                    data-parsley-pattern="/^[a-zA-Z0-9\s]+$/" required />
                            </div>
